...
if(!typesFileName) {
  console.error();
  console.error('Expecting first argument types.ala file name.');
  console.error();
  console.error('curl https://raw.githubusercontent.com/ALAIO/ala/master/libraries/types/types.ala > types.ala');
  console.error('./type_parser.js types.ala > schema/generated.json')
  console.error();
